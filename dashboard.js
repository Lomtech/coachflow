...
function updateCoachInfo() {
  document.getElementById('coachName').textContent = currentCoach.name || currentCoach.email;
  document.getElementById('coachPlan').textContent = getPlanName(currentCoach.plan);
}
...
function setupEventListeners() {
  ...
  document.getElementById('uploadForm').addEventListener('submit', uploadContent);
  document.getElementById('copyLinkBtn').addEventListener('click', copyMembershipLink);
}
